...
public class MonthlyOutlierFilterPredicateTest {
    ...
    @Inject
    MonthlyOutlierFilter filterPredicate;
    ...
    @Test
    @DisplayName("When the price is far above the upper threshold, then it should be filtered")
    ...
    @Test
    @DisplayName("When the price is exactly at the upper threshold, then it should not be filtered")
    ...
    @Test
    @DisplayName("When the price is a whole number above the upper threshold, then it should be filtered")
    ...
    @Test
    @DisplayName("When the price is a few decimals below the upper threshold, then it should not be filtered")
    ...
    @Test
    @DisplayName("When the price is far below the bottom threshold, then it should be filtered")
    ...
    @Test
    @DisplayName("When the price is exactly at the bottom threshold, then it should be filtered")
    ...
    @Test
    @DisplayName("When the price is a whole number below the bottom threshold, then it should be filtered")
    ...
    @Test
    @DisplayName("When the price is a few decimals above the bottom threshold, then it should not be filtered")
